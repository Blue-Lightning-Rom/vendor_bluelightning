...
# SGS2 overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/bluelightning/overlay/s2-common

# PA OVERLAY_TARGET
OVERLAY_TARGET := pa_hdpi

# Setup device specific product configuration.
PRODUCT_NAME := bluelightning_i9100g
...
PRODUCT_COPY_FILES += \
    vendor/bluelightning/prebuilt/hdpi/bootanimation.zip:system/media/bootanimation.zip
